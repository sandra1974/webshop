<%-- 
    Document   : jackets
    Created on : 24-Jan-2018, 21:04:54
    Author     : sandr
--%>
    ...
    <body>
      <sql:setDataSource var="dbsource" driver="com.mysql.jdbc.Driver"
        ...
        <sql:query dataSource="${dbsource}" var="products">
            SELECT * from heroku_2e32f1f5d7f29ce.product where name="sport jacket";
        </sql:query>
  ...
  <div class="w3-bar w3-black w3-card">
    ...
    <div class="w3-black  w3-dropdown-hover w3-hide-small">
      ...
      <div class="w3-black  w3-dropdown-content w3-bar-block w3-card-4">
        ...
        <a href="#shopjackets" class="w3-bar-item w3-button">Jackets</a>
...
<div class="w3-content" style="max-width:2000px;margin-top:46px">
  ...
  <!-- The Shop Section -->
  <div class="w3-theme-l2" id="shopjackets">
    <div class="w3-container w3-content w3-padding-64" style="max-width:800px">
      <h2 class="w3-wide w3-center">BROWSE SHOP</h2>
      <p class="w3-opacity w3-center"><i>In our webshop you will find various modern designs of jackets</p><br>

<%-- 
    Document   : trousers
    Created on : 24-Jan-2018, 20:58:48
    Author     : sandr
--%>
    ...
    <body>
      <sql:setDataSource var="dbsource" 
        ...
        <sql:query dataSource="${dbsource}" var="products">
            SELECT * from heroku_2e32f1f5d7f29ce.product where name="comfort trousers";
        </sql:query>
...
<div class="w3-content" style="max-width:2000px;margin-top:46px">
  ...
  <!-- The Shop Section -->
  <div class="w3-theme-l2" id="shoptrousers">
    <div class="w3-container w3-content w3-padding-64" style="max-width:800px">
      <h2 class="w3-wide w3-center">BROWSE SHOP</h2>
      <p class="w3-opacity w3-center"><i>In our webshop you will find various modern designs of trousers</p><br>

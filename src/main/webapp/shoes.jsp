<%-- 
    Document   : shoes
    Created on : 24-Jan-2018, 21:39:27
    Author     : sandr
--%>
    ...
    <body>
     <sql:setDataSource var="dbsource" 
        ...
        <sql:query dataSource="${dbsource}" var="products">
            SELECT * from heroku_2e32f1f5d7f29ce.product where name="modern shoes";
        </sql:query>
...
<div class="w3-top">
  <div class="w3-bar w3-black w3-card">
    ...
    <div id="demoAcc" class="w3-black  w3-bar-block w3-hide w3-padding-large w3-medium">
      ...
      <a href="#shopshoes" class="w3-bar-item w3-button">Shoes</a>
...
<div class="w3-content" style="max-width:2000px;margin-top:46px">
  ...
  <!-- The Shop Section -->
  <div class="w3-theme-l2" id="shopshoes">
    <div class="w3-container w3-content w3-padding-64" style="max-width:800px">
      <h2 class="w3-wide w3-center">BROWSE SHOP</h2>
      <p class="w3-opacity w3-center"><i>In our webshop you will find various models of shoes</p><br>

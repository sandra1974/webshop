<%-- 
    Document   : bag
    Created on : 24-Jan-2018, 21:33:02
    Author     : sandr
--%>
    ...
    <body>
     <sql:setDataSource var="dbsource" 
        ...
        <sql:query dataSource="${dbsource}" var="products">
            SELECT * from heroku_2e32f1f5d7f29ce.product where name="exclusive bag";
        </sql:query>
  ...
  <div class="w3-bar w3-black w3-card">
    ...
    <div class="w3-black  w3-dropdown-hover w3-hide-small">
      ...
      <div class="w3-black  w3-dropdown-content w3-bar-block w3-card-4">
        <a href="#shopdress" class="w3-bar-item w3-button">Dresses</a>
        <a href="shirt.jsp#shopshirt" class="w3-bar-item w3-button">Shirts</a>
        <a href="#shoptrousers" class="w3-bar-item w3-button">Trousers</a>
        <a href="jackets.jsp#shopjackets" class="w3-bar-item w3-button">Jackets</a>
        <a href="#shopcoats" class="w3-bar-item w3-button">Coats</a>
    ...
    <div id="demoAcc" class="w3-black  w3-bar-block w3-hide w3-padding-large w3-medium">
      <a href="#shopbag" class="w3-bar-item w3-button">Bags</a>
...
<div class="w3-content" style="max-width:2000px;margin-top:46px">
  ...
  <!-- The Shop Section -->
  <div class="w3-theme-l2" id="shopbag">
    <div class="w3-container w3-content w3-padding-64" style="max-width:800px">
      <h2 class="w3-wide w3-center">BROWSE SHOP</h2>
      <p class="w3-opacity w3-center"><i>In our webshop you will find various modern designs of bags</p><br>
      ...
      <tr>
          ...
          <a href="${initParam.productImagePath}${product.name}.jpg">
                        ...
                        <div class="w3-container w3-light-grey"  style="width:50%">
                        ...
                        <form action="cart" method="POST">
                          ...
                          <input type="submit"  style="width:100%"  onclick="document.getElementById('info').style.display='block'"  class="w3-button w3-blue-grey w3-margin-bottom" value="More Info">
                       </td>
